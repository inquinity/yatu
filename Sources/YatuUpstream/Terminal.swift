...
//  https://github.com/Ji4n1ng/OpenInTerminal — OpenInTerminalCore/ScriptingBridge/Terminal.swift
//  as of upstream commit eaa3bd5 (2019-04-17). Copied verbatim below this
//  header; see LICENSE and docs/UPSTREAM.md.
//
//  A ScriptingBridge interface generated from Terminal's .sdef. It has not
//  changed upstream since 2019 and is regenerable with sdef(1) and
//  sdp(1) should it ever need to be.
//
import AppKit
