...
> **This is the record of why Yatu is built the way it is, not the plan.** Decisions, rules,
> findings and the reasoning behind reversals live here, and source comments cite it by section
> number (§3 findings, §4.1 rules, §5 settings, §9 the extension). What is being done next is in
